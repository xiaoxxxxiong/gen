/** soft constraint **/
delimiter //
drop procedure if exists proc_sft;
create procedure proc_sft (
...
_exit_:begin
        ...
        begin
                ...
                rollback;
                insert into xlg (udt, prc, ctt) values (_udt, 'proc_sft', _msg);
                set _ret = 1;
	...
	select	*,
	 ...
	 from sft where stp = 0 and opt < 4 and udt = _udt
	) a;
